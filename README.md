...
screenshot-sessions ~/Pictures/Game --copy-to ~/Pictures/Game-Sessions
```

Recognizable `YYYY-MM-DD_HH-MM-SS` filename timestamps take priority; other images use filesystem modification times. A new session begins after the configured gap. Copy export stages a new destination and refuses existing, nested, temporary, or colliding targets.
